...
--
-- Host: localhost
-- Generation Time: Sep 25, 2013 at 05:37 AM
...
('74f020e2c84511e2910c7c10', 'Pendidikan'),
...
CREATE TABLE IF NOT EXISTS `dlmbg_reply_forum` (
  ...
  `id_anggota` varchar(24) NOT NULL,
...
('52b5165e1d5911e39cb9a4ba', '1109100352', '558211bac94f11e2910c7c10da17e330', 'xaxaxads sds', '<p>ssxxxa dsd lkdls</p>', '2013-09-15', '01:18:42'),
('c63e9992cc3711e29a37a2f2', '5e7b22acc62a11e291df14da', '558211bac94f11e2910c7c10da17e330', '-', '<p>gileeee lu ndro</p><p>&nbsp;</p>', '2013-06-03', '19:24:29'),
...
(1, 'site_title', 'Nama Situs', 'Aplikasi Beban Kinerja Dosen'),
(2, 'site_footer', 'Teks Footer', 'Copyright &copy; 2013 Aplikasi Kinerja Dosen | Designed &amp; Developed by Gede Lumbung - http://gedelumbung.com'),
(3, 'site_quotes', 'Quotes Situs', 'Rumah Sakit Bargawastra Wijaya - Health for Nation'),
(4, 'site_theme', 'Nama Tampilan', 'blue-dot'),
(5, 'key_login', 'Key Hash Login', 'AppBebanDosen32'),
...
('558211bac94f11e2910c7c10da17e330', '74f020e2c84511e2910c7c10', 'a41faba8c93a11e2910c7c10', 'Resep Jomblo Biar Awet Muda - The Power of ngeFap', '<p>anda jomblo??</p><p>pengen awet muda??</p><p>coba ngeFap, banyak teman saya yang jomblo, setelah ngeFap, merek awet muda</p><p>Sudah terbukti oleh teman saya, tapi saya belum coba</p><p>kapan-kapan aja #halah</p>', '2013-05-31 02:35:34', '2013-09-16 05:52:48', 73),
...
('5865641c1d5111e39cb9a4bab767df26', '78520098c84511e2910c7c10', '1109100352', 'naskeleng', '<p>ocokolok</p>', '2013-09-15 00:21:36', '2013-09-15 01:15:40', 21);
...
INSERT INTO `tbldosen` (`id_dosen`, `dosen`, `alamat`, `tempat_lahir`, `tgl_lahir`, `pend_terakhir`) VALUES
(1, 'H. Chairul Anam, SE', '', '', '', ''),
...
(16, 'Erda Habiby, ST', '', '', '', ''),
(17, 'Drs. Mohamad Dedi', '', '', '', ''),
(18, 'Eko Heri Susanto, S.Kom', 'pacitan', 'pacitan', '2013-09-25', 'S2'),
...
(26, 'Nur Ahmadi, ST', '', '', '', ''),
(27, 'Sudjadi, MT', '', '', '', ''),
(33, 'Adi Januardi Jarot', 'Banyuwangi', 'Denpasar', '2013-09-30', 'S1');
...
(12, 87, 1, 'admin', 2, 2, '50.0'),
(13, 87, 1, 'ahmadi', 4, 0, '0.0'),
(14, 87, 1, '1109100352', 4, 0, '0.0');
...
(24, '1109100352', 'admin', 'ok', '<p>halo<br /><br />================<strong>BALAS</strong>================<br /><br /><strong>Administrator</strong> : josss</p>', '09-09-2013 | 07:04:pm', 'Y'),
(25, 'admin', '1109100352', 'ok', '<p>halo<br /><br />================<strong>BALAS</strong>================<br /><br /><strong>Administrator</strong> : josss</p>', '09-09-2013 | 07:04:pm', 'Y'),
(26, '1109100352', 'ekoheri', 'tes pak dosen', 'say helooo', '22-09-2013 | 12:09:am', 'Y'),
(27, '1109100352', 'admin', 'halo bang admin', 'tes doang kok bang :))', '22-09-2013 | 12:11:am', 'N');
...
INSERT INTO `tbllogin` (`username`, `psw`, `nama`, `status`, `idlink`, `gbr`) VALUES
...
('gede', '*749E8C608E8AC1DCC3C54264FCE17AC739BEB6A6', 'Adi Januardi Jarot', 'PA', '33', ''),
('1112100870', '*F3F6B3035C1626BB83FFFD403309D0689FBD9F9D', 'Gede Becing Becing', 'Mahasiswa', '1112100870', '');
...
CREATE TABLE IF NOT EXISTS `tblmahasiswa` (
...
INSERT INTO `tblmahasiswa` (`id_mahasiswa`, `nama`, `alamat`, `angkatan`, `tempat_lahir`, `tgl_lahir`, `jurusan`) VALUES
('1106000001', 'Abdul Ridwan', 'pacitan', '2009', 'Denpasar', '2013-09-01', 'TI'),
('1112100870', '', 'Wayabung, TuBa, Lampung', '2009', 'Denpasar', '2013-09-25', 'TEKNIK INFORMATIKA');
...
INSERT INTO `tblmatkul` (`id_mk`, `semester`, `kode_mk`, `nama_mk`, `sks`, `id_dosen`, `prasyarat`, `prodi`, `nama_file`) VALUES
(1, 1, 3009201, 'Manajemen Umum', 2, 1, '122', 'MI', ''),
...
(24, 3, 3009308, 'Desain Web', 2, 18, '3009307, 3009203', 'MI', '1279008355.zip'),
...
(97, 5, 1009320, 'Pemrograman Berbasis Web', 3, 18, '1009314, 1009304', 'TI', '1373923848.pdf'),
...
(11, 1, '33', 'Berdasarkan bentuknya, media penyimpan dapat dibagi kedalam 3 kelompok, yaitu magnetis, optis, Elektronis. Yang termasuk kedalam media penyimpan optic adalah...', 'CD', 'Memory', 'Disket', 'Hard Disk', '', 'a', ''),
...
(16, 1, '4', 'Yang bukan merupakan tipe data dalam pemrograman C# adalfah...', 'Int', 'Char', 'Double', 'For', '', 'd', ''),
(17, 1, '4', 'Salah satu fungsi perulangan yang sering dipakai dalam dunia pemrograman adalah...', 'While', 'If', 'Switch', 'Or', '', 'a', ''),
(18, 1, '87', 'Kepanjangan dari CSS adalah...', 'Cascading Style Sheeter', 'Component Social System', 'Configuration Style System', '', '', 'a', ''),
(19, 1, '87', 'Sub-sub menu yang muncul ketika suatu link disentuh/on hover disebut...', 'Slider', 'Drop Down', 'Tab', 'Tree', '', '', ''),
(20, 1, '87', 'Yang bukan merupakan attribut dari tag table ialah...', 'width', 'height', 'align', 'border', 'id', 'e', ''),
(21, 1, '2', 'Fungsi dari tag br dalam penulisan kode HTML ialah....', 'Memberikan jarak ke bawah tanpa spasiiiii', 'Memberikan jarak ke bawah dengan 1 spasi', 'Memberikan jarak ke bawah dengan 2 spasi', 'Memberikan jarak ke bawah dengan 3 spasi', '', 'a', '');
